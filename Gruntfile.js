...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
    	  //  pkg: grunt.file.readJSON('package.json'),
            ...
            clean: {
//            	options : {
//            		// risky it will delete forcefullys
//            	//	force : true,
//            		no-write : true
//            	},
                build: [
            ...
            concat: {
                styles: {
                    ...
                    dest: '<%= config.path.temp.root %>/concat/css/webapplication.css'
                }
            },
            */
            ...
            htmlmin: {
                prod: {
                    ...
                    files: [
                        {
                            expand: true,
                            cwd: '<%= config.path.build.root %>',  // all paths are relative to this path
                            src: ['index.html'],
    ...
    // According to me this is not required becaue alreay taken care by bower
